...
public interface IHotelService {
	...
	Room addRoom(int roomNumber, RoomType roomType) throws RoomAlreadyExistsException, RoomTypeNotFoundException;
	...
	boolean removeBookingFromCheckIn(Booking booking);
